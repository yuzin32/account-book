...
<?
if(!isset($tapmode))$tapmode='a_c'; echo "tapmode:".$tapmode;
//지출/수입 카테고리 
        ...
        <div class="diary-wrap">
            ...
            <!-- 메뉴--><? include_once "/demoyujin/www/account_book/html/include/menu.php"; ?> 
                    ...
                    <div class="setting-wrap">
                        <ul class="tab-list">
                            <li <?if($tapmode=='a_c'){?>class="on"<?}?>><a href="basisecode.php?tapmode=a_c"><span class="ico"><img src="/account_book/html/skin/img/ico_setting_menu01.svg" alt="지출/수입"></span> 지출/수입</a></li>
                            ...
                            <div class="tc tc01">
                                ...
                                <table class="c-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" class="single"name="account_category_idx[]" value="<?echo $ac_row['account_category_idx'];?>"></td>
                                            <td>
                                            ...
                                            <td><input type="checkbox" class="single" name="statistics_use[]" value="y" <?checked_on('y',$ac_row['statistics_use'])?>></td>
                                        </tr>
                                        <?}?>
                                    </tbody>
                                    <!--지출수입카테고리end-->
                                ...
                                <table class="c-table">
                                    ...
                                    <tbody>
                                        <? foreach ($bank_rows as $b_row) { ?>
                                        <tr>
                                            <td><input type='checkbox' class="single"name="systemcode_idx[]" value="<?echo $b_row['systemcode_idx'];?>" ></td>
