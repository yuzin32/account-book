            ...
            <!-- 메뉴--><? include_once "/demoyujin/www/account_book/html/include/menu.php"; ?> 
                    ...
                    <div class="setting-wrap">
                        ...
                        <div class="tab-con-wrap">
                            <form name="basise_form" action="/account_book/html/new_tap06/basisecode.call.php"  method="POST">
   ...
   <!-- ***** 신규등록 모달창 START ***** -->
    ...
    <div class="modal-wrap new-code" style="display:none">
        ...
        <div class="modal">
            ...
            <div class="m-body">
                <form name="basise_saveform" action="/account_book/html/new_tap06/basisecode.call.php"  method="POST">
                <input type='hidden' name="smode" value="<?=$tapmode?>_save">
                <input type='hidden' name="tapmode" value="<?=$tapmode?>">
                <div class="form-wrap">
                <?if($tapmode=='ac'){?>
